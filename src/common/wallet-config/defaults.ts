import { ICoinDefaultConfig } from '../../types';
import * as erc20Abi from '../ABI/erc20.json';

class CoinsSupportedBase {
  public readonly btc: ICoinDefaultConfig = {
    name: 'Bitcoin',
  ...
  public readonly eth: ICoinDefaultConfig = {
    name: 'Ethereum',
    symbol: 'ETH',
  ...
  public readonly green: ICoinDefaultConfig = {
    name: 'Green',
    symbol: 'GREEN',
  ...
  public readonly arcade: ICoinDefaultConfig = {
    name: 'Arcade',
    symbol: 'ARCADE',
...
export default new CoinsSupportedBase();