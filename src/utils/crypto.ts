...
class Crypto {
  ...
  public encrypt(plainText: string, secret: string) {
    logger.debug(`utils.crypto.encrypt.config.clientSecretKeyRequired:${config.clientSecretKeyRequired}`)
  ...
  public decrypt(encryptedText: string, secret: string) {
    logger.debug(`utils.crypto.decrypt.config.clientSecretKeyRequired:${config.clientSecretKeyRequired}`)
